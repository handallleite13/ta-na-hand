...
const footerHtml = \
  ...
  <footer class="mt-auto py-10 border-t border-slate-800 bg-slate-900 text-center">
    <div class="max-w-7xl mx-auto px-4 flex flex-col items-center gap-3">
      ...
      <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-slate-800 rounded-full border border-slate-700 shadow-inner">
      ...
      <p class="text-xs text-slate-600 max-w-md">Plataforma em desenvolvimento ativo. Rumo à versão 1.0 funcional e escalável.</p>
    </div>
  </footer>
\;
